...
pub fn main() !void {
    ...
    const lighting_shader = try learnopengl.Shader.init("shaders/16_1_light_casters.vs", "shaders/16_1_light_casters.fs");
    ...
    while (!window.shouldClose()) {
        ...
        lighting_shader.use();
        lighting_shader.setFloat3("light.direction", -0.2, -1.0, -0.3);
