...
pub fn main() !void {
    ...
    const lighting_shader = try learnopengl.Shader.init("shaders/14_1_materials.vs", "shaders/14_1_materials.fs");
    const light_cube_shader = try learnopengl.Shader.init("shaders/14_1_materials_light_cube.vs", "shaders/14_1_materials_light_cube.fs");
