...
pub fn main() !void {
    ...
    const lighting_shader = try learnopengl.Shader.init("shaders/15_3_lighting_maps.vs", "shaders/15_3_lighting_maps.fs");
    const light_cube_shader = try learnopengl.Shader.init("shaders/15_3_lighting_maps_light_cube.vs", "shaders/15_3_lighting_maps_light_cube.fs");
