...
pub fn main() !void {
    ...
    const lighting_shader = try learnopengl.Shader.init("shaders/14_2_materials.vs", "shaders/14_2_materials.fs");
    const light_cube_shader = try learnopengl.Shader.init("shaders/14_2_materials_light_cube.vs", "shaders/14_2_materials_light_cube.fs");
    ...
    while (!window.shouldClose()) {
        ...
        lighting_shader.setFloat3("material.ambient", 0.0, 0.1, 0.06);
        lighting_shader.setFloat3("material.diffuse", 0.0, 0.50980392, 0.50980392);
        lighting_shader.setFloat3("material.specular", 0.50196078, 0.50196078, 0.50196078);
        lighting_shader.setFloat("material.shininess", 32.0);

        lighting_shader.setFloat3("light.ambient", 1.0, 1.0, 1.0);
        lighting_shader.setFloat3("light.diffuse", 1.0, 1.0, 1.0);
