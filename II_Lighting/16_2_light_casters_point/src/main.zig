...
pub fn main() !void {
    ...
    const lighting_shader = try learnopengl.Shader.init("shaders/16_2_light_casters.vs", "shaders/16_2_light_casters.fs");
    const light_cube_shader = try learnopengl.Shader.init("shaders/16_2_light_cube.vs", "shaders/16_2_light_cube.fs");
