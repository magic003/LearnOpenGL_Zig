...
pub fn main() !void {
    ...
    const lighting_shader = try learnopengl.Shader.init("shaders/17_1_multiple_lights.vs", "shaders/17_1_multiple_lights.fs");
    ...
    const point_light_positions = [_][3]f32 {
        .{0.7, 0.2, 2.0},
        .{2.3, -3.3, -4.0},
        .{-4.0, 2.0, -12.0},
        .{0.0, 0.0, -3.0},
    ...
    while (!window.shouldClose()) {
        ...
        // directional light
        lighting_shader.setFloat3("dirLight.position", -0.2, -1.0, -0.3);
        lighting_shader.setFloat3("dirLight.ambient", 0.05, 0.05, 0.05);
        lighting_shader.setFloat3("dirLight.diffuse", 0.4, 0.4, 0.4);
        lighting_shader.setFloat3("dirLight.specular", 0.5, 0.5, 0.5);

        // point light 1
        lighting_shader.setFloat3("pointLights[0].position", point_light_positions[0][0], point_light_positions[0][1], point_light_positions[0][2]);
        lighting_shader.setFloat3("pointLights[0].ambient", 0.05, 0.05, 0.05);
        lighting_shader.setFloat3("pointLights[0].diffuse", 0.8, 0.8, 0.8);
        lighting_shader.setFloat3("pointLights[0].specular", 1.0, 1.0, 1.0);
        ...
        // point light 2
        lighting_shader.setFloat3("pointLights[1].position", point_light_positions[1][0], point_light_positions[1][1], point_light_positions[1][2]);
        lighting_shader.setFloat3("pointLights[1].ambient", 0.05, 0.05, 0.05);
        lighting_shader.setFloat3("pointLights[1].diffuse", 0.8, 0.8, 0.8);
        lighting_shader.setFloat3("pointLights[1].specular", 1.0, 1.0, 1.0);
        ...
        // point light 3
        lighting_shader.setFloat3("pointLights[2].position", point_light_positions[2][0], point_light_positions[2][1], point_light_positions[2][2]);
        lighting_shader.setFloat3("pointLights[2].ambient", 0.05, 0.05, 0.05);
        lighting_shader.setFloat3("pointLights[2].diffuse", 0.8, 0.8, 0.8);
        lighting_shader.setFloat3("pointLights[2].specular", 1.0, 1.0, 1.0);
        ...
        // point light 4
        lighting_shader.setFloat3("pointLights[3].position", point_light_positions[3][0], point_light_positions[3][1], point_light_positions[3][2]);
        lighting_shader.setFloat3("pointLights[3].ambient", 0.05, 0.05, 0.05);
        lighting_shader.setFloat3("pointLights[3].diffuse", 0.8, 0.8, 0.8);
        lighting_shader.setFloat3("pointLights[3].specular", 1.0, 1.0, 1.0);
        ...
        // spotLight
        lighting_shader.setFloat3("spotLight.position", camera.position[0], camera.position[1], camera.position[2]);
        lighting_shader.setFloat3("spotLight.direction", camera.front[0], camera.front[1], camera.front[2]);
        lighting_shader.setFloat3("spotLight.ambient", 0.0, 0.0, 0.0);
        lighting_shader.setFloat3("spotLight.diffuse", 1.0, 1.0, 1.0);
        lighting_shader.setFloat3("spotLight.specular", 1.0, 1.0, 1.0);
        ...
        lighting_shader.setFloat("spotLight.cutOff", @cos(to_radians(12.5)));
        lighting_shader.setFloat("spotLight.outerCutOff", @cos(to_radians(17.5)));
