...
pub fn main() !void {
    ...
    const lighting_shader = try learnopengl.Shader.init("shaders/13_1_basic_lighting.vs", "shaders/13_1_basic_lighting.fs");
    const light_cube_shader = try learnopengl.Shader.init("shaders/13_1_light_cube.vs", "shaders/13_1_light_cube.fs");
