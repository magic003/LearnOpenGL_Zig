...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        .name = "9_2_coordinate_systems_depth",
    ...
    const install_vs_step = b.addInstallFile(.{ .path = "src/9_2_coordinate_systems.vs" }, "bin/9_2_coordinate_systems.vs");
    run_step.dependOn(&install_vs_step.step);
    const install_fs_step = b.addInstallFile(.{ .path = "src/9_2_coordinate_systems.fs" }, "bin/9_2_coordinate_systems.fs");
