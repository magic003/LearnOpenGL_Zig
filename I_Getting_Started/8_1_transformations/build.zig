...
pub fn build(b: *std.Build) void {
    ...
    const install_vs_step = b.addInstallFile(.{ .path = "src/8_1_transformations.vs" }, "bin/8_1_transformations.vs");
    run_step.dependOn(&install_vs_step.step);
    const install_fs_step = b.addInstallFile(.{ .path = "src/8_1_transformations.fs" }, "bin/8_1_transformations.fs");
