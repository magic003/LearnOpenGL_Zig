...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        .name = "8_2_transformations_exercise1",
    ...
    const install_vs_step = b.addInstallFile(.{ .path = "src/8_2_transformations.vs" }, "bin/8_2_transformations.vs");
    run_step.dependOn(&install_vs_step.step);
    const install_fs_step = b.addInstallFile(.{ .path = "src/8_2_transformations.fs" }, "bin/8_2_transformations.fs");
