...
pub fn build(b: *std.Build) void {
    ...
    const install_vs_step = b.addInstallFile(.{ .path = "src/10_2_camera.vs" }, "bin/10_2_camera.vs");
    run_step.dependOn(&install_vs_step.step);
    const install_fs_step = b.addInstallFile(.{ .path = "src/10_2_camera.fs" }, "bin/10_2_camera.fs");
