...
pub fn main() !void {
    ...
    const shader = try learnopengl.Shader.init("9_4_coordinate_systems.vs", "9_4_coordinate_systems.fs");
    ...
    while (!window.shouldClose()) {
        ...
        for (cube_positions, 0..) |cube_position, i| {
            ...
            const angle: f32 = if (i % 3 != 0) 20.0 * @as(f32, @floatFromInt(i)) else @floatCast(glfw.getTime() * 25.0);
