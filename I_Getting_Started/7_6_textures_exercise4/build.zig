...
pub fn build(b: *std.Build) void {
    ...
    const install_vs_step = b.addInstallFile(.{ .path = "src/7_6_texture.vs" }, "bin/7_6_texture.vs");
    run_step.dependOn(&install_vs_step.step);
    const install_fs_step = b.addInstallFile(.{ .path = "src/7_6_texture.fs" }, "bin/7_6_texture.fs");
