...
pub fn build(b: *std.Build) void {
    ...
    const install_vs_step = b.addInstallFile(.{ .path = "src/6_6_shader.vs" }, "bin/6_6_shader.vs");
    run_step.dependOn(&install_vs_step.step);
    const install_fs_step = b.addInstallFile(.{ .path = "src/6_6_shader.fs" }, "bin/6_6_shader.fs");
